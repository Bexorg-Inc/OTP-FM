...
class TestTraining:
    ...
    def test_trainer_instantiation(self, simple_gaussian_model, gaussian_dataloaders, device, tmp_path):
...
class TestGaussianTrainer:
    ...
    def test_gaussian_trainer_instantiation(self, simple_gaussian_model, gaussian_dataloaders, normalized_gaussian_data, device, tmp_path):
    ...
    def test_save_trajectories(self, simple_gaussian_model, gaussian_dataloaders, normalized_gaussian_data, device, tmp_path):
...
class TestIntegration:
    ...
    def test_model_checkpoint_save_load(self, simple_gaussian_model, gaussian_dataloaders, device, tmp_path):
