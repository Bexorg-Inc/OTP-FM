...
from fm_explore.beijingair import dataset, plotting, BeijingTrainer
...
def beijing_marginals_dict(synthetic_beijing_data):
    ...
    return {
        ...
        for i, m in enumerate(synthetic_beijing_data)
    }
...
class TestTrainer:
    ...
    def test_trainer_creation(self, simple_model, synthetic_beijing_data, beijing_marginals_dict, tmp_path, device):
    ...
    def test_trainer_short_training(self, simple_model, synthetic_beijing_data, beijing_marginals_dict, tmp_path, device):
